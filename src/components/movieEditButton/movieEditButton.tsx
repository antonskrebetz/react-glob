import styles from './movieEditButton.module.scss';

interface IMovieEditButtonProps {
    onClick: React.MouseEventHandler<SVGSVGElement>;
}

const MovieEditButton = ({onClick}: IMovieEditButtonProps) => {
    return (
        <svg className={styles.editButton} onClick={onClick} width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
